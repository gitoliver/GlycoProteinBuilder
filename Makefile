...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fr. Jun 23 16:13:31 2017
# Project:  glycoproteinBuilder.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile glycoproteinBuilder.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I$(GEMSHOME)/gmml/includes/ -I$(GEMSHOME)/gmml/bin -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L$(GEMSHOME)/gmml/bin/ -lgmml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: glycoproteinBuilder.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile glycoproteinBuilder.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/gp_builder1.0.0 || $(MKDIR) .tmp/gp_builder1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gp_builder1.0.0/ && $(COPY_FILE) --parents glycosylationsite.h overlap.h io.h attachedrotamer.h .tmp/gp_builder1.0.0/ && $(COPY_FILE) --parents main.cpp glycosylationsite.cpp overlap.cpp io.cpp attachedrotamer.cpp .tmp/gp_builder1.0.0/ && (cd `dirname .tmp/gp_builder1.0.0` && $(TAR) gp_builder1.0.0.tar gp_builder1.0.0 && $(COMPRESS) gp_builder1.0.0.tar) && $(MOVE) `dirname .tmp/gp_builder1.0.0`/gp_builder1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gp_builder1.0.0
